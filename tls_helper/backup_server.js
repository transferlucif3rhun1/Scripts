...
function getCurrentBinary() {
  ...
  if (binaryFile) {
    ...
    if (fs.existsSync(binaryPath)) {
      return { filename: binaryFile, path: binaryPath };
    }
  }
...
async function initialize() {
  try {
    ...
    app.listen(NODE_PORT, () => {
      ...
      log("Endpoints: /, /raw, /payload, /cookies");
